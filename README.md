...
1\) Run `get_comp_graphs.py` to extract protein complex interfaces. Then run `get_comp_graphs.py` to construct graph representations and save them as .npy files.<br>
